...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			boolean agregado = supermercado.agregarProducto("Fideos", 1000);
			System.out.println("Se ha agregado el producto? "+agregado);
		} catch (Exception e) {
			System.err.println(e.getMessage());
		}
		
		try {
			boolean agregado = supermercado.agregarProducto("Aceite", 1000);
			System.out.println("Se ha agregado el producto? "+agregado);
		} catch (Exception e) {
			System.err.println(e.getMessage());
		}
		...
		try {
			boolean agregado = supermercado.agregarProducto("fideos", 5000);
			System.out.println("Se ha agregado el producto? "+agregado);
		} catch (Exception e) {
			System.err.println(e.getMessage());
		}
